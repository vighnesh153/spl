...
describe('should return correct block or ' +
    ...
    const defineVariable = (name: string, value: any, type: string) => {
...
describe('should assign values to array or ' +
    ...
    const defineArray = (name: string, value: any, type: string) => {
