...
describe('check functionality of display block.', () => {
    ...
    let outputBuffer = OutputBuffer.instance;
    beforeEach(() => {
        outputBuffer.flush();
    });

    test('should add newline character to output ' +
    ...
    test('should add numbers to the output ' +
    ...
    test('should add booleans to the output ' +
    ...
    test('should add strings to the output ' +
    ...
    test('should add mixed datatype values along with ' +
        'variable values to the output buffer.', () => {
        const scope = new Scope();
        const variableBlock = new VariableBlock(
            VariableBlockType.declare,
            'iAmAVariable',
            'string', 'LoL', true, scope
        );
        variableBlock.execute();
